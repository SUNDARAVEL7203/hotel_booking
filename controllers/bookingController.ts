...
const razorpay = new Razorpay({
    key_id: "rzp_test_YrbAeQtnqK9kkS", // Replace with your Razorpay Key ID
    key_secret: "wYUsViPH6pQtYfoqdOosay3W", // Replace with your Razorpay Key Secret
  });
...
export const createOrder = asyncHandler(async (req: IUserRequest, res: Response) => {
    try {
